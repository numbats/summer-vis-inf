...
v21.sl.sim.fitted <- std_res(v21.sl.sim)
```

```{r lcrsimnull-v21}

# least confounded conditional residual
v21.sl.simlcr <- lcr_res(v21.sl.sim)
```
...
```{r nullfitted-v22}
v22.sl.sim.fitted <- std_res(v22.sl.sim)
```

```{r lcrsimnull-v22}
v22.sl.simlcr <- lcr_res(v22.sl.sim)
```
...
```{r nullfitted-v23}
v23.sl.sim.fitted <- std_res(v23.sl.sim)
```

```{r lcrsimnull-v23}
v23.sl.simlcr <- lcr_res(v23.sl.sim)
```
...
v24.sl.sim.fitted <- std_res(v24.sl.sim)
```

```{r lcrsimnull-v24}

v24.sl.simlcr <- lcr_res(v24.sl.sim)
```
...
v31.sl.sim.fitted <- std_res(v31.sl.sim)

```

```{r lcrsimnull-v31}

v31.sl.simlcr <- lcr_res(v31.sl.sim)
...
```{r nullfitted-v32}
v32.sl.sim.fitted <- std_res(v32.sl.sim)
```

```{r lcrsimnull-v32}
v32.sl.simlcr <- lcr_res(v32.sl.sim)
```
...
v33.sl.sim.fitted <- std_res(v33.sl.sim)
```

```{r lcrsimnull-v33}

v33.sl.simlcr <- lcr_res(v33.sl.sim)
```
...
```{r nullfitted-v34}
v34.sl.sim.fitted <- std_res(v34.sl.sim)
```

```{r lcrsimnull-v34}

v34.sl.simlcr <- lcr_res(v34.sl.sim)
```
