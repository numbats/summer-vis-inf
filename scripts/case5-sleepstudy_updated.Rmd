...
ggplot(sl.fitted, aes(index, 
  ...
  geom_text(data = sl.fitted %>% filter(resm_std>2), 
            aes(label = index), 
            nudge_x = 0.35, 
            nudge_y = 0.35, 
            size = 2)
...
ggplot(sl.fitted, aes(index, 
  ...
  geom_point() + 
  geom_hline(yintercept = 0) + 
  geom_text(data = sl.fitted %>% filter(abs(resc_std)>3), 
            aes(label = index), 
            nudge_x = 0.35, 
            nudge_y = 0.35, 
            size = 2)
...
v2.sl <- tibble(y, sleepstudy$Days, 
                sleepstudy$Subject)
...
ggplot(v2.sl.fitted, aes(index, 
  ...
  geom_point() + 
  geom_hline(yintercept = 0) + 
  geom_text(data = v2.sl.fitted %>% filter(abs(resm_std) > 3), 
            aes(label = index), 
            nudge_x = 0.35, 
            nudge_y = 0.35, 
            size = 2)
...
ggplot(v2.sl.fitted, aes(index, 
  ...
  geom_point() + 
  geom_hline(yintercept = 0) + 
  geom_text(data = v2.sl.fitted %>% filter(abs(resc_std) > 3), 
            aes(label = index), 
            nudge_x = 0.35, 
            nudge_y = 0.35, 
            size = 2)
...
s21.1 <- lineup(true = v2.sl.fitted, 
...
s21.2 <- lineup(true = v2.sl.fitted, 
                samples = v21.sl.sim.fitted, 
                pos = 5) %>% 
  ggplot(aes(index, 
             resc_std, 
...
s21.3 <- lineup(true = v2.sl.fitted, 
                samples = v21.sl.sim.fitted, 
                pos = 8) %>% 
...
s22.1 <- lineup(true = v2.sl.fitted, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v22_1.png", 
  plot = s22.1, device = "png", dpi = 300,
  height = 12, width = 12)
```

```{r v22n-plo4, fig.height=6}
s22.2 <- lineup(true = v2.sl.fitted, 
                samples = v22.sl.sim.fitted,
                pos = 5) %>% 
  ggplot(aes(index, 
             resc_std, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v22_2.png", 
...
s22.3 <- lineup(true = v2.sl.fitted, 
                samples = v22.sl.sim.fitted, 
                pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v22_3.png", 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v22_4.png", 
...
s23.1 <- lineup(true = v2.sl.fitted, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v23_1.png", 
...
s23.2 <- lineup(true = v2.sl.fitted, 
                samples = v23.sl.sim.fitted, 
                pos = 15) %>% 
  ggplot(aes(index, 
             resc_std, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v23_2.png", 
...
s23.3 <- lineup(true = v2.sl.fitted, 
                samples = v23.sl.sim.fitted, 
                pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v23_3.png", 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v23_4.png", 
...
s24.1 <- lineup(true = v2.sl.fitted, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v24_1.png", 
...
s24.2 <- lineup(true = v2.sl.fitted, 
                samples = v24.sl.sim.fitted, 
                pos = 15) %>% 
  ggplot(aes(index, 
             resc_std, 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v24_2.png", 
...
s24.3 <- lineup(true = v2.sl.fitted, 
                samples = v24.sl.sim.fitted, 
                pos = 20) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v24_3.png", 
...
ggsave(path= here::here("figures/lineup/"),filename = "slp_v24_4.png", 
...
samp_df <- tibble(samp_df)

samp_df$y <- samp_df$y + 
             mean(sleepstudy$y)*0.40
...
ggsave(path= here::here("figures/second/"),
...
s31.1 <- lineup(true = v3.sl.fitted, 
...
ggsave(path= here::here("figures/lineup/"),
...
s31.2 <- lineup(true = v3.sl.fitted, 
                samples = v31.sl.sim.fitted, 
                pos = 15) %>% 
  ggplot(aes(index, 
             resc_std, 
...
s31.3 <- lineup(true = v3.sl.fitted, 
                samples = v31.sl.sim.fitted, 
                pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
s32.1 <- lineup(true = v3.sl.fitted, 
...
s32.2 <- lineup(true = v3.sl.fitted, 
                samples = v32.sl.sim.fitted, 
                pos = 15) %>% 
  ggplot(aes(index, 
             resc_std, 
...
s32.3 <- lineup(true = v3.sl.fitted, 
                samples = v32.sl.sim.fitted, 
                pos = 11) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
s33.1 <- lineup(true = v3.sl.fitted, 
...
s33.2 <- lineup(true = v3.sl.fitted, 
                samples = v33.sl.sim.fitted, 
                pos = 2) %>% 
  ggplot(aes(index, 
             resc_std, 
...
s33.3 <- lineup(true = v3.sl.fitted, 
                samples = v33.sl.sim.fitted, 
                pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
s34.1 <- lineup(true = v3.sl.fitted, 
...
s34.2 <- lineup(true = v3.sl.fitted, 
                samples = v34.sl.sim.fitted, 
                pos = 2) %>% 
  ggplot(aes(index, 
             resc_std, 
...
s34.3 <- lineup(true = v3.sl.fitted, 
                samples = v34.sl.sim.fitted, 
                pos = 6) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
