...
```{r v1-plots}
ggplot(v1.lin.fitted, aes(index, 
                          resm_std, 
                          color = subject)) + 
  geom_point() + 
  geom_hline(yintercept = 0) +
...
```{r v11n-plot}
lineup(true = v1.lin.fitted, 
       samples = v11.lin.sim.fitted, 
       pos = 9) %>% 
...
```{r v11n-plot21}
l11.1 <- lineup(true = v1.lin.fitted, 
                samples = v11.lin.sim.fitted, 
                pos = 7) %>% 
  ggplot(aes(index, 
             resm_std, 
...
```{r v11n-plot4}
l11.2 <- lineup(true = v1.lin.fitted, 
                samples = v11.lin.sim.fitted, 
                pos = 7) %>% 
  ggplot(aes(index, 
             resc_std, 
...
```{r v11n-plot6}
l11.3 <- lineup(true = v1.lin.fitted, 
                samples = v11.lin.sim.fitted, 
                pos = 9) %>% 
...
```{r}
l11.4 <- lineup(true = v1.lin.lcr, 
                samples = v11.lin.sim.lcr, 
                pos = 9) %>% 
...
```{r v12n-plot2}
l12.1 <- lineup(true = v1.lin.fitted, 
                samples = v12.lin.sim.fitted, 
                pos = 7) %>% 
  ggplot(aes(index, 
             resm_std, 
...
```{r v12n-plot4}
l12.2 <- lineup(true = v1.lin.fitted, 
                samples = v12.lin.sim.fitted, 
                pos = 7) %>% 
  ggplot(aes(index, 
             resc_std, 
...
```{r v12n-plot6}
l12.3 <- lineup(true = v1.lin.fitted, 
                samples = v12.lin.sim.fitted, 
                pos = 9) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
```{r v12n-plot-lcr}
l12.4 <- lineup(true = v1.lin.lcr, 
                samples = v12.lin.sim.lcr, 
                pos = 9) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + 
  geom_qq_line(color = "red") +
...
```{r v13n-plot21}
l13.1 <- lineup(true = v1.lin.fitted, 
                samples = v13.lin.sim.fitted, 
                pos = 13) %>% 
  ggplot(aes(index, 
             resm_std, 
             color = subject)) +
...
```{r v13n-plot4}
l13.2 <- lineup(true = v1.lin.fitted, 
                samples = v13.lin.sim.fitted, 
                pos = 13) %>% 
  ggplot(aes(index, 
             resc_std, 
...
```{r v13n-plot6}
l13.3 <- lineup(true = v1.lin.fitted, 
                samples = v13.lin.sim.fitted, 
                pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
...
```{r v13n-plot-lcr}
l13.4 <- lineup(true = v1.lin.lcr, 
                samples = v13.lin.sim.lcr, 
                pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + 
  geom_qq_line(color = "red") +
...
```{r v14n-plot21}
l14.1 <- lineup(true = v1.lin.fitted, 
                samples = v14.lin.sim.fitted, 
                pos = 13) %>% 
  ggplot(aes(index, 
             resm_std, 
...
```{r v14n-plot4}
l14.2 <- lineup(true = v1.lin.fitted, 
                samples = v14.lin.sim.fitted, 
                pos = 13) %>% 
  ggplot(aes(index, 
             resc_std, 
...
```{r v14n-plot6}
l14.3 <- lineup(true = v1.lin.fitted, 
                samples = v14.lin.sim.fitted, 
                pos = 4) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + 
...
```{r v14n-plot-lcr}
l14.4 <- lineup(true = v1.lin.lcr, 
                samples = v14.lin.sim.lcr, 
                pos = 4) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + 
  geom_qq_line(color = "red") +
...
```{r v2-plots}
lin21 <- ggplot(v2.lin.fitted, aes(index, resm_std, color = subject)) +
  geom_point() +
  geom_hline(yintercept = 0) +
  xlab(NULL) +
  ylab(NULL) +
...
ggplot(v2.lin.fitted, aes(sample = resc_std)) +
  geom_qq() +
  geom_qq_line(color = "red")
ggplot(v2.lin.lcr, aes(sample = reslc_lin)) +
  geom_qq() +
  geom_qq_line(color = "red")
```
...
```{r v21n-plot}
lineup(true = v2.lin.fitted, 
       samples = v21.lin.sim.fitted, 
       pos = 9) %>% 
  ggplot(aes(interaction(attitude, gender), 
             resm_std)) +
  geom_boxplot() +
...
```{r v21n-plot21}
l21.1 <- lineup(true = v2.lin.fitted, 
                samples = v21.lin.sim.fitted, 
                pos = 5) %>% 
  ggplot(aes(index, 
             resm_std, 
...
```{r v21n-plot4}
l21.2 <- lineup(true = v2.lin.fitted, 
                samples = v21.lin.sim.fitted, 
                pos = 5) %>% 
...
```{r v21n-plot6}
l21.3 <- lineup(true = v2.lin.fitted, 
                samples = v21.lin.sim.fitted, 
                pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
...
```{r v21n-plot6-lcr}
l21.4 <- lineup(true = v2.lin.lcr, 
                samples = v21.lin.sim.lcr, 
                pos = 8) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
...
```{r v22n-plot22}
l22.1 <- lineup(true = v2.lin.fitted, 
                samples = v22.lin.sim.fitted, 
                pos = 5) %>% 
  ggplot(aes(index, 
             resm_std, 
             color = subject)) +
...
```{r v22n-plot4}
l22.2 <- lineup(true = v2.lin.fitted, 
                samples = v22.lin.sim.fitted, 
                pos = 5) %>% 
  ggplot(aes(index, 
             resc_std, 
...
```{r v21n-plot6}
l22.3 <- lineup(true = v2.lin.fitted, 
                samples = v22.lin.sim.fitted, 
                pos = 8) %>% 
  ggplot(aes(sample = resc_std)) + 
  geom_qq() + geom_qq_line(color = "red") +
...
```{r v21n-plot6-lcr}
l22.4 <- lineup(true = v2.lin.lcr, 
                samples = v22.lin.sim.lcr, 
                pos = 8) %>% 
  ggplot(aes(sample = reslc_lin)) + 
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap( ~ .sample, ncol=5) +
...
```{r v23n-plot21}
l23.1 <- lineup(true = v2.lin.fitted, 
                samples = v23.lin.sim.fitted, 
                pos = 15) %>% 
  ggplot(aes(index, 
             resm_std, 
...
```{r v23n-plot}
l23.2 <- lineup(true = v2.lin.fitted, 
                samples = v23.lin.sim.fitted, 
                pos = 15) %>%
  ggplot(aes(index, 
             resc_std, 
...
```{r v23n-plot6}
l23.3 <- lineup(true = v2.lin.fitted, 
                samples = v23.lin.sim.fitted, 
                pos = 20) %>%
  ggplot(aes(sample = resc_std)) +
  geom_qq() +
...
```{r v21n-plot6-lcr}
l23.4 <-
  lineup(true = v2.lin.lcr,
         samples = v23.lin.sim.lcr,
         pos = 20) %>%
  ggplot(aes(sample = reslc_lin)) +
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap(~ .sample, ncol = 5) +
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v24_1.png",
  plot = l24.1,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v24_2.png",
  plot = l24.2,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v24_3.png",
  plot = l24.3,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v24_4.png",
  plot = l24.4,
  device = "png",
  dpi = 300,
  height = 12,
...
m_pol <-
  round(as.numeric(
    df %>% filter(gender == "M", attitude == "pol") %>% summarise(mean(y))
  ), 1)
...
m_inf <-
  round(as.numeric(
    df %>% filter(gender == "M", attitude == "inf") %>% summarise(mean(y))
  ), 1)
...
f_inf <-
  round(as.numeric(
    df %>% filter(gender == "F", attitude == "inf") %>% summarise(mean(y))
  ), 1)
...
```{r}
ggplot(v3.lin.fitted, aes(index, 
                          resm_std, 
                          color = subject)) + 
  geom_point() + 
  geom_hline(yintercept = 0)
...
lin_dp2 <-
  ...
  theme()
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/second_presentation/lin_dp2.png",
  plot = lin_dp2,
  device = "png",
  dpi = 300
)

lin_dp3 <-ggplot(v3.lin.fitted, 
                 aes(sample = resc_std)) + 
  geom_qq() + 
  geom_qq_line(color = "red") + 
  xlab(NULL) + 
...
ggplot(v3.lin.lcr, aes(sample = reslc_lin)) + 
  geom_qq() + 
  geom_qq_line(color = "red")
```
...
l31.1 <-
  lineup(true = v3.lin.fitted,
         samples = v31.lin.sim.fitted,
         pos = 15) %>%
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v31_1.png",
  plot = l31.1,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v31_2.png",
  plot = l31.2,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v31_3.png",
  plot = l31.3,
  device = "png",
  dpi = 300,
  height = 12,
...
l31.4 <-
  lineup(true = v3.lin.lcr,
         samples = v31.lin.sim.lcr,
         pos = 11) %>%
  ggplot(aes(sample = reslc_lin)) +
  geom_qq() + geom_qq_line(color = "red") +
  facet_wrap(~ .sample, ncol = 5) +
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v31_4.png",
  plot = l31.4,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v32_1.png",
  plot = l32.1,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v32_2.png",
  plot = l32.2,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v32_3.png",
  plot = l32.3,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v32_4.png",
  plot = l32.4,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v33_1.png",
  plot = l33.1,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v33_2.png",
  plot = l33.2,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v33_3.png",
  plot = l33.3,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v33_4.png",
  plot = l33.4,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v34_1.png",
  plot = l34.1,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v34_2.png",
  plot = l34.2,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v34_3.png",
  plot = l34.3,
  device = "png",
  dpi = 300,
  height = 12,
...
ggsave(
  filename = "~/Desktop/Masters/Master_Econometrics/S2 2020/ETF5550/master/figures/lineups/lin_v34_4.png",
  plot = l34.4,
  device = "png",
  dpi = 300,
  height = 12,
